...
The file `maddpg_agent.py` contains the code for the agent, and the `model.py` contains the code for the actor and critic Neural Network that our MADDPG uses.
